...
setup(
    ...
    install_requires=['numpy', 'matplotlib', 'tensorflow', 'Keras', 'keras-pos-embd==0.9.0', 'keras-transformer==0.21.0', 'tqdm', 'faiss', 'sklearn', 'pycurl', 'multiprocessing', 'unicodedata', 'six', 'argparse', 'glob', 'math'], 
    classifiers=(
